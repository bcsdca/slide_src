function test_parse_scripture() {
  ...
  //array_str.push(str1, str2, str3, str4, str5, str6, str7, str8, str9, str10, str11, str12, str13, str14);
  array_str.push(str13);
  //Logger.log(array_str)


  for (var i = 0; i < array_str.length; i++) {
    var a_temp = array_str[i].split("Reading")
