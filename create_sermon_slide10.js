...
// version 10 removing sermon_dstId, just created a new one each time, and dont needed to clean the old one
// just duplicate over the sermon_srcId
...
function create_sermon_slide10() {

  const sermon_srcId = "17ICWjVc-SPbXWc7WPRfnwl2gBd-yahYzozXyF3Qvrog";
  //sermon_dstId file is duplicate of sermon_srcId file without the "_template" in the name
  //thus avoiding the slide_remove_copy and file_duplicate routines at the end
  var sermon_dstId = file_duplicate1(sermon_srcId);
  ...
  Logger.log("announcement_Contents = " + announcement_Contents);
  ...
  Logger.log("Yea, Done with creating this Sunday's sermon slides !!!");

  SpreadsheetApp.getActive().toast("Yea, Done with creating this Sunday's sermon slides !!!", "👍");
