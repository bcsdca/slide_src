...
function test_parse_invocation1(i) {
  ...
  for (var i = 0; i < array_str.length; i++) {
    ...
    if (a_temp.length > 1) {
      ...
      for (var j = 0; j < a_temp1.length; j++) {
        ...
        if ((a0.length == 2) || (a0.length == 1)) {
          ...
          if (a2.length == 4) {
            ...
            console.log(arguments.callee.name + ": This invocation passage format1 is not supported: \"%s\"", array_str[i])
            break;
          }
          ...
          console.log(arguments.callee.name + ": This invocation passage format2 is not supported: \"%s\"", array_str[i])
          break;
        }
      ...
      console.log(arguments.callee.name + ": This invocation passage format3 is not supported: \"%s\"", array_str[i])
      //break;
    }
  }
