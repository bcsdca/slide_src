...
function two_gmail_to_ss19() {
  ...
  try {
    ...
    var message = threads[0].getMessages()[2];
    ...
    if (find_pdf) {
      ...
      + ": Emily's email attachment content type is %s, and the attachment file name is %s", attachment.getContentType(), attachment.getName())
    } else {
  ...
  try {
    ...
    console.log(arguments.callee.name + ": The cantonese worship reminder email message length is " + cant_message_length)
