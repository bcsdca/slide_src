...
// using find_title_slide without specifying position(12/5/2022)
// removing the constant fellowship_dstId, just created a new one each time, and dont needed to clean the old one
// just duplicate over the fellowship_srcId
// allow no vido link for the song slides

function create_fellowship_slide3() {
  ...
  //fellowship_dstId file is duplicate of fellowship_srcId file without the "_template" in the name
  //thus avoiding the slide_remove_copy and file_duplicate routines at the end
  var fellowship_dstId = file_duplicate1(fellowship_srcId);
  ...
  SpreadsheetApp.getActive().toast("Yea, Done with creating fellowship slides !!!", "👍");
